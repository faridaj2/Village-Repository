    ...
    <body class="font-sans antialiased bg-white text-gray-900">
        ...
        <section class="pt-16">
            <div class="relative h-[450px] sm:h-[550px] overflow-hidden bg-gray-900" id="heroSlider">
                ...
                <!-- Hero Content -->
                <div class="absolute inset-x-0 bottom-20 z-20 flex flex-col items-center px-4">
                    <h1 class="text-3xl sm:text-5xl font-bold text-white text-center mb-2 drop-shadow-lg">Desa Waeleman</h1>
                    <p class="text-sm sm:text-base text-white/80 text-center">Sistem Informasi Desa</p>
                    <a href="{{ route('pengumuman.publik') }}" class="mt-6 px-8 py-3.5 text-sm font-semibold text-white bg-gray-900 rounded-lg hover:bg-gray-700 transition-colors">Lihat Pengumuman</a>
                </div>
        ...
        <footer class="py-10 px-4 sm:px-6 border-t border-gray-100">
            <div class="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-2">
                    <img src="{{ asset('logo-tagline.png') }}" alt="SIDESA" class="h-8 w-auto">
                </div>
